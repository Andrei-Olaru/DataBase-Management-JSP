...
<html>
    ...
    <body>
        <h1>Tabela Album</h1>
        <p><a href="nou_Consultatie.jsp" class="button">Adaugă un nou album</a></p>
        <form action="m1_Album.jsp" method="post">
            <table>
                <tr>
                    <th>Mark</th>
                    <th>Id Album</th>
            ...
            <button type="submit" class="button" style="width:auto">Modifică linia</button>
        </form>
